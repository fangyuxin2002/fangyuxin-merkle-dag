...
func TestDagStructure(t *testing.T) {
	...
	hasher.Reset()
	bigFileContent, err := os.ReadFile("D:\\code\\merkle-dag\\2021131132_方妤心_1.rar")
	if err != nil {
		t.Error(err)
	}
...
func TestDagToFile(t *testing.T) {
	...
	originalContent, _ := os.ReadFile("D:\\code\\merkle-dag\\newfolder")
